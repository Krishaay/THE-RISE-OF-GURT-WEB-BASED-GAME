...
export class MainMenuScene extends Phaser.Scene {
    ...
    create() {
        ...
        fullscreenButton.on("pointerover", () =>
            fullscreenButton.setStyle({ backgroundColor: "#8b5a2b" })
        );

        fullscreenButton.on("pointerout", () =>
            fullscreenButton.setStyle({ backgroundColor: "#6b4226" })
        );
        ...
        const creditsButton = this.add.text(this.scale.width / 2, this.scale.height * 0.84, "Credits", {
            fontFamily: "Cinzel, serif",
            fontSize: "36px",
            color: "#ffffff",
            backgroundColor: "#6b4226",
